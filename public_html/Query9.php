...
echo "
<th>Generate a ticket for each customer for the past month. </th>
<th>The ticket includes the customer name, arrival and departure places, plane-id and departure, arrival times.</th>
<table border='1'>
<tr>
<th>CustomerName</th>
