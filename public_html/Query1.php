...
$result = mysqli_query($con,"select C.user_name,max(SSK.Distance) as D
from 
...
where SSK.customer_id=C.customer_id and SSK.date>'2016-01-01' and SSK.date<'2017-01-01'
group by C.user_name desc limit 1
");

echo "
<th>Find the customer who has been flighted the most distance in two years ago.</th>
<table border='1'>
<tr>
<th>user_name</th>
<th>D</th>
